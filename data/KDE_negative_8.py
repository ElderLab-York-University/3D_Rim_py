...
# 打开文件，准备读取
with open("Thingi10k_data8.pkl", "rb") as f:
...
with open("predicted_normal_curvature_thingi10K8N.pkl", "wb") as f:
    # 使用pickle.dump将字典保存到文件
    pickle.dump(predicted_normal_curvature, f)
'''
with open("predicted_normal_curvature_thingi10K8N.pkl", "rb") as f:
    # 使用pickle.load从文件中加载字典
...
plt.title("Mean and Standard Error of Normal Curvature vs Apparent Curvature (positive part)")
plt.legend()
plt.show()