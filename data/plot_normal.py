...
plt.hist(normal_curvature,bins=500,range=(0,4000),density=True)

print(sum(contour_counter))
print(sum(counter))
plt.ylabel('Probability P($γ_N$)')
plt.xlabel('Normal curvature $γ_N$ (radian/unit object length)')
plt.title('Distribution of normal curvature')
plt.show()
